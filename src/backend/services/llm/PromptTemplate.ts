...
Always respond in clean markdown. Prioritize recency and significance. Always return stories for every category: if a portal search comes up short, search other reputable sources or draw on your knowledge of recent events rather than reporting that news is unavailable. Never reply that no news is available.`,
      user_prompt_template: `Return the latest news for these topics: {topics}.
        ...
        '## Top News - {Date}': [
          {
            ...
            category: 'String - business, stock-market, sports, or math',
          },
        ],
      },
      usage_instruction: `Replace {topics} with a comma-separated list relevant to ${country}. For age group ${ageGroup}.`,
    };
  }
